...
void Player::mapInteraction(float time,sf::Clock &eatableClock)
{
...
void Player::update(float &CurrentFrame,float time, sf::Clock &eatableClock)
{
	prevState = state;
	...
	mapInteraction(time, eatableClock);
}
